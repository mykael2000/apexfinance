...
<!-- Mirrored from apexfinancecredit.com/terms by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 11 Oct 2025 21:44:55 GMT -->
...
<head>
    <meta name="google-site-verification" content=""/>
        <title>Apex Finance Credit</title>
    <meta name="description" content="Apex Finance Credit | We are here to serve you better and help save your money without charges.." />
    <meta property="og:locale" content="en_EN" />
    <meta property="og:type" content="website" />
    <meta property="og:title" content="Apex Finance Credit - We are here to serve you better and help save your money without charges.." />
            <meta property="og:description" content="Apex Finance Credit | We are here to serve you better and help save your money without charges" />
        <meta property="og:image" content="storage/app/public/photos/qNXF4NDyNjx2bqNvKE6GThT5Hl6HT9Ee3T0Drdzg.png" />
        <meta property="og:url" content="index.php" />
    <meta property="og:site_name" content="Apex Finance Credit" />
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:description" content="Welcome to a new era of banking at Apex Finance Credit, where traditional boundaries fade away and possibilities expand.." />
    <meta name="twitter:title" content="Apex Finance Credit - We are here to serve you better and help save your money without charges.." />
    <meta name="twitter:image" content="storage/app/public/photos/qNXF4NDyNjx2bqNvKE6GThT5Hl6HT9Ee3T0Drdzg.png" />

    <!--favicon icon-->
    <link rel="icon" href="storage/app/public/photos/qNXF4NDyNjx2bqNvKE6GThT5Hl6HT9Ee3T0Drdzg.png" type="image/png" sizes="16x16">

    <!--google fonts-->
    <link href="fonts.googleapis.co/css1644164416441644.html?family=Montserrat:400,500,600,700%7COpen+Sans:400,600&amp;display=swap" rel="stylesheet">
    ...
    <link rel='stylesheet' href='fonts.googleapis.co/icone91fe91fe91fe91f.html?family=Material+Icons'>
    ...
    <nav class="navbar navbar-expand-lg fixed-top">
        <div class="container">
            <a class="navbar-brand" href="index.php">
                <img src="storage/app/public/photos/rnaxX97vE61cQEoOT6xDiehSkpsnSbvEWlLu2WFk.png" style="height: 60px; width: 150px;" alt="Apex Finance Credit" class="img-fluid"/>
            </a>
            ...
            <div class="collapse navbar-collapse h-auto" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto menu">
                    ...
                    <li><a style="opacity: 1;" href="register.php" class="btn btn-sm btn-primary p-2 mb-2">Open Account</a></li>
                    <li><a style="opacity: 1;" href="login.php" class="btn outline-white-btn p-2 text-white">Online Banking</a></li>
...
<div class="main">
                  ...
                  <div class="page-header-content text-white text-center pt-sm-5 pt-md-5 pt-lg-0">
                      ...
                      <div class="custom-breadcrumb">
                          <ol class="breadcrumb d-inline-block bg-transparent list-inline py-0">
                              <li class="list-inline-item breadcrumb-item active">Apex Finance Credit</li>
                          </ol>
                      </div>
                  </div>
              </div>
    ...
    Apex Finance Credit is not available to the general public and is opened only to the qualified members of geminiglobalfinance, the use of this site is restricted to our members and to individuals personally invited by them. Every deposit is considered to be a private transaction between the Apex Finance Credit and its Member.<br><br>
    ...
    As a private transaction, this program is exempt from the US Securities Act of 1933, the US Securities Exchange Act of 1934 and the US Investment Company Act of 1940 and all other rules, regulations and amendments thereof. We are not FDIC insured. We are not a licensed bank or a security firm.<br><br>
      You agree that all information, communications, materials coming from Apex Finance Credit
    ...
    All the data giving by a member to Apex Finance Credit will be only privately used and not disclosed to any third parties.Apex Finance Credit is not responsible or liable for any loss of data.<br><br>
    ...
    Apex Finance Credit is not responsible or liable for any damages, losses and costs resulting from any violation of the conditions and terms and/or use of our website by a member. You guarantee to Apex Finance Creditthat you will not use this site in any illegal way and you agree to respect your local, national and international laws.<br><br>
    ...
    Apex Finance Credit reserves the right to accept or decline any member for membership without explanation.<br><br>
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="footer-nav-wrap text-white">
                                ...
                                <ul class="nav flex-column">
                                    <li class="nav-item">
                                        <a class="nav-link" href="register.php">Open Account</a>
                                    </li>
                                    <li class="nav-item">
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="footer-nav-wrap text-white">
                                ...
                                <ul class="nav flex-column">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="terms.php">Privacy Policy</a>
                                    </li>
                                    <!-- <li class="nav-item">
                        ...
                        <div class="col-12">
                            <div class="footer-nav-wrap text-white">
                                ...
                                <ul class="get-in-touch-list">
                                    <li class="d-flex align-items-center py-2"><span class="fas fa-map-marker-alt mr-2"></span> 214 North Tryon Street, Charlotte, North Carolina, 28202 </li>
                                   ...
                                   <li class="d-flex align-items-center py-2"><i class="fas fa-comments"></i>&nbsp;&nbsp;<a href='#'> admin@apexfinancecredit.com </a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-md-5 col-lg-5">
                    <p class="copyright-text pb-0 mb-0">Copyrights © 2023. All
                        rights reserved
                        <a href="index.php" target="_blank" class='text-white'>Apex Finance Credit</a></p>
                </div>
...
<!--jQuery-->
<script data-cfasync="false" src="../cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script data-cfasync="false" src="cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.html"></script><script src="temp/custom/base/js/jquery-3.4.1.min.js"></script>
<!--Popper js-->
...
<script src="http://code.jivosite.com/widget/7RoMS9jQ1O" async></script>
    ...
    <script src="http://code.tidio.co/<script src="//code.jivosite.com/widget/7RoMS9jQ1O" async></script>" async></script>
