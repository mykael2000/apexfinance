...
<head>
    ...
    <title>Apex Finance Credit | Reset Password</title>
    ...
    <link rel="shortcut icon" href="https://apexfinancecredit.com/storage/app/public/photos/qNXF4NDyNjx2bqNvKE6GThT5Hl6HT9Ee3T0Drdzg.png" />
    ...
    <div class="flex-1 min-w-0">
        ...
        <p class="text-xs text-gray-500 truncate">
            ID: <?php echo $user['account_id']; ?>
                        ...
                        <div class="mb-3">
                                                            <a href="https://apexfinancecredit.com/dashboard/verify-account" class="flex items-center justify-center py-1 rounded-md bg-red-50 border border-red-100 hover:bg-red-100 transition-colors">
                        ...
                        <div class="flex space-x-2">
                            <a href="https://apexfinancecredit.com/dashboard/account-settings" class="flex-1 inline-flex justify-center items-center px-2.5 py-1.5 border border-gray-300 shadow-sm text-xs font-medium rounded text-gray-700 bg-white hover:bg-gray-50">
                                <i data-lucide="user" class="h-3 w-3 mr-1"></i> Profile
                            </a>
                            <a href="https://apexfinancecredit.com/logout"
                            ...
                            <form id="logout-form-sidebar" action="https://apexfinancecredit.com/logout" method="POST" style="display: none;">
                ...
                <nav class="flex-1 px-4 space-y-1">
                    ...
                    <a href="https://apexfinancecredit.com/dashboard" class="flex items-center px-3 py-2.5 text-sm font-medium rounded-lg text-gray-700 hover:bg-gray-50">
                        <i data-lucide="home" class="mr-3 h-5 w-5 text-gray-500"></i>
                        Dashboard
                    </a>

                    <a href="https://apexfinancecredit.com/dashboard/accounthistory" class="flex items-center px-3 py-2.5 text-sm font-medium rounded-lg text-gray-700 hover:bg-gray-50">
                        <i data-lucide="activity" class="mr-3 h-5 w-5 text-gray-500"></i>
                        Transactions
                    </a>

                    <!-- Cards Menu Item -->
                    <a href="https://apexfinancecredit.com/dashboard/cards" class="flex items-center px-3 py-2.5 text-sm font-medium rounded-lg text-gray-700 hover:bg-gray-50">
                    ...
                    <a href="https://apexfinancecredit.com/dashboard/localtransfer" class="flex items-center px-3 py-2.5 text-sm font-medium rounded-lg text-gray-700 hover:bg-gray-50">
                        <i data-lucide="send" class="mr-3 h-5 w-5 text-gray-500"></i>
                        Local Transfer
                    </a>

                    <a href="https://apexfinancecredit.com/dashboard/internationaltransfer" class="flex items-center px-3 py-2.5 text-sm font-medium rounded-lg text-gray-700 hover:bg-gray-50">
                        <i data-lucide="globe" class="mr-3 h-5 w-5 text-gray-500"></i>
                        International Wire
                    </a>

                    <a href="https://apexfinancecredit.com/dashboard/deposits" class="flex items-center px-3 py-2.5 text-sm font-medium rounded-lg text-gray-700 hover:bg-gray-50">
                    ...
                    <a href="https://apexfinancecredit.com/dashboard/loan" class="flex items-center px-3 py-2.5 text-sm font-medium rounded-lg text-gray-700 hover:bg-gray-50">
                        <i data-lucide="credit-card" class="mr-3 h-5 w-5 text-gray-500"></i>
                        Loan Request
                    </a>

                    <a href="https://apexfinancecredit.com/dashboard/irs-refund" class="flex items-center px-3 py-2.5 text-sm font-medium rounded-lg text-gray-700 hover:bg-gray-50">
                        <i data-lucide="receipt" class="mr-3 h-5 w-5 text-gray-500"></i>
                        IRS Tax Refund
                    </a>

                    <a href="https://apexfinancecredit.com/dashboard/viewloan" class="flex items-center px-3 py-2.5 text-sm font-medium rounded-lg text-gray-700 hover:bg-gray-50">
                    ...
                    <a href="https://apexfinancecredit.com/dashboard/account-settings" class="flex items-center px-3 py-2.5 text-sm font-medium rounded-lg text-gray-700 hover:bg-gray-50">
            ...
            <header class="bg-white shadow-sm z-20">
                <div class="flex items-center justify-between px-4 py-3">
                    ...
                    <div class="flex items-center md:hidden">
                        ...
                        <a href="/" class="ml-4">
                            <img src="apexlogo.png" alt="Logo" class="h-8 w-auto">
                        </a>
                    </div>
                        ...
                        <div class="relative" x-data="{ notificationsOpen: false }">
                            ...
                            <div
                                ...
                                <div class="px-4 py-3 border-t border-gray-100 text-center">
                                    <a href="https://apexfinancecredit.com/dashboard/notifications" class="text-sm font-medium text-black hover:text-primary-500">View all notifications</a>
                                </div>
                            </div>
                        </div>
    ...
    <span class="sr-only">Open user menu</span>
            ...
            ME
                            ...
                            <div
                                ...
                                <div class="px-4 py-3 border-b border-gray-100">
                                    ...
                                    <!-- KYC Verification Status -->
                                                                            <div class="mt-2">
                                            <a href="https://apexfinancecredit.com/dashboard/verify-account" class="px-2 py-1 text-xs rounded-full bg-red-100 text-red-800 hover:bg-red-200 flex items-center w-max">
                                ...
                                <a href="https://apexfinancecredit.com/dashboard/account-settings" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 flex items-center" role="menuitem">
                                    <i data-lucide="user" class="h-4 w-4 mr-3 text-gray-500"></i> My Profile
                                </a>
                                <a
                                    href="https://apexfinancecredit.com/logout"
                                ...
                                <form id="logout-form-header" action="https://apexfinancecredit.com/logout" method="POST" style="display: none;">
                                    <input type="hidden" name="_token" value="MJ3oshkEFdsEktrfbMCK0JvF1Q196j6lk1QiONcb">
                                </form>
                            </div>
                        </div>
            ...
            ME
                        ...
                        <div>
                            ...
                            <!-- KYC Verification Status -->
                                                            <div class="mt-1">
                                    <a href="https://apexfinancecredit.com/dashboard/verify-account" class="px-2 py-0.5 text-xs rounded-full bg-red-100 text-red-800 hover:bg-red-200 inline-flex items-center">
                                        <i data-lucide="alert-circle" class="h-3 w-3 mr-1"></i> Verify Account
                                    </a>
                                </div>
                                                    </div>
                    ...
                    <div class="grid grid-cols-3 gap-3">
                        <a href="https://apexfinancecredit.com/dashboard" class="group">
                        ...
                        <a href="https://apexfinancecredit.com/dashboard/accounthistory" class="group">
                        ...
                        <a href="https://apexfinancecredit.com/dashboard/cards" class="group">
                            <div class="aspect-square flex flex-col items-center justify-center rounded-xl bg-gradient-to-br from-primary-50 to-primary-100 hover:from-primary-100 hover:to-primary-200 transition-all duration-300 p-2">
                                <div class="h-10 w-10 rounded-full bg-white flex items-center justify-center mb-1 shadow-sm group-hover:shadow transition-all">
                        ...
                        <a href="https://apexfinancecredit.com/dashboard/localtransfer" class="group">
                            <div class="aspect-square flex flex-col items-center justify-center rounded-xl bg-gradient-to-br from-secondary-50 to-secondary-100 hover:from-secondary-100 hover:to-secondary-200 transition-all duration-300 p-2">
                                <div class="h-10 w-10 rounded-full bg-white flex items-center justify-center mb-1 shadow-sm group-hover:shadow transition-all">
                        ...
                        <a href="https://apexfinancecredit.com/dashboard/internationaltransfer" class="group">
                            <div class="aspect-square flex flex-col items-center justify-center rounded-xl bg-gradient-to-br from-secondary-50 to-secondary-100 hover:from-secondary-100 hover:to-secondary-200 transition-all duration-300 p-2">
                                <div class="h-10 w-10 rounded-full bg-white flex items-center justify-center mb-1 shadow-sm group-hover:shadow transition-all">
                        ...
                        <a href="https://apexfinancecredit.com/dashboard/deposits" class="group">
                            <div class="aspect-square flex flex-col items-center justify-center rounded-xl bg-gradient-to-br from-primary-50 to-primary-100 hover:from-primary-100 hover:to-primary-200 transition-all duration-300 p-2">
                                <div class="h-10 w-10 rounded-full bg-white flex items-center justify-center mb-1 shadow-sm group-hover:shadow transition-all">
                        ...
                        <a href="https://apexfinancecredit.com/dashboard/loan" class="group">
                            <div class="aspect-square flex flex-col items-center justify-center rounded-xl bg-gradient-to-br from-secondary-50 to-secondary-100 hover:from-secondary-100 hover:to-secondary-200 transition-all duration-300 p-2">
                                <div class="h-10 w-10 rounded-full bg-white flex items-center justify-center mb-1 shadow-sm group-hover:shadow transition-all">
                        ...
                        <a href="https://apexfinancecredit.com/dashboard/irs-refund" class="group">
                            <div class="aspect-square flex flex-col items-center justify-center rounded-xl bg-gradient-to-br from-primary-50 to-primary-100 hover:from-primary-100 hover:to-primary-200 transition-all duration-300 p-2">
                                <div class="h-10 w-10 rounded-full bg-white flex items-center justify-center mb-1 shadow-sm group-hover:shadow transition-all">
                        ...
                        <a href="https://apexfinancecredit.com/dashboard/account-settings" class="group">
                            <div class="aspect-square flex flex-col items-center justify-center rounded-xl bg-gradient-to-br from-primary-50 to-primary-100 hover:from-primary-100 hover:to-primary-200 transition-all duration-300 p-2">
                                <div class="h-10 w-10 rounded-full bg-white flex items-center justify-center mb-1 shadow-sm group-hover:shadow transition-all">
                        ...
                        <form id="logout-form-grid" action="https://apexfinancecredit.com/logout" method="POST" style="display: none;">
                            <input type="hidden" name="_token" value="MJ3oshkEFdsEktrfbMCK0JvF1Q196j6lk1QiONcb">
                        </form>
                    </div>
                </div>
            ...
            <div class="fixed bottom-0 left-0 right-0 md:hidden z-30">
                ...
                <div class="bg-white border-t border-gray-200 shadow-lg rounded-t-3xl mx-2 mb-1">
                    <div class="flex justify-between items-center px-6 py-3 relative">
                        <a href="https://apexfinancecredit.com/dashboard" class="flex flex-col items-center">
                        ...
                        <a href="https://apexfinancecredit.com/dashboard/accounthistory" class="flex flex-col items-center">
                            <div class="w-10 h-10 rounded-full flex items-center justify-center">
                        ...
                        <a href="https://apexfinancecredit.com/dashboard/cards" class="flex flex-col items-center">
                            <div class="w-10 h-10 rounded-full flex items-center justify-center">
                        ...
                        <a href="https://apexfinancecredit.com/dashboard/account-settings" class="flex flex-col items-center">
                            <div class="w-10 h-10 rounded-full flex items-center justify-center">
...
<div class="container mx-auto px-4 py-6 max-w-4xl">
    ...
    <div class="flex flex-col mb-6">
        <div>
            ...
            <div class="flex items-center text-sm text-gray-500">
                ...
                <a href="https://apexfinancecredit.com/dashboard/account-settings" class="hover:text-primary-600">Settings</a>
                <i data-lucide="chevron-right" class="h-4 w-4 mx-2"></i>
    ...
    <div class="bg-white rounded-xl shadow-md border border-gray-100 overflow-hidden">
        ...
        <!-- Form Content -->
        <div class="p-6">
            <form action="https://apexfinancecredit.com/dashboard/updatepass" method="post">
